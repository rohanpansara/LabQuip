...
const productFormQuantity = document.querySelector('.productForm-quantity');
const productFormPurchaseDate = document.querySelector('.productForm-purchaseDate');
const productFormWarrantyPeriod = document.querySelector('.productForm-warrantyPeriod');
const productFormPOnumber = document.querySelector('.productForm-poNum');
const productFormInvoiceNumber = document.querySelector('.productForm-invoiceNum');
const productFormSupplierName = document.querySelector('.productForm-supplierName');
const productFormSupplierPhone = document.querySelector('.productForm-supplierPhone');
const productFormSupplierAddress = document.querySelector('.supplierForm-supplierAddress');
const productFormDescription = document.querySelector('.productForm-productDescription');
const productFormAllotmentLoc = document.querySelector('.productForm-allotmentLoc');
const inventoryProductFormStatus = document.querySelectorAll('.inventoryForm-status');
const inventoryProductFormRemainingQuantity = document.querySelectorAll('.inventoryForm-RemainingQuantity');
...
if (productEditButtons) {
  productEditButtons.forEach((btn) => {
    btn.addEventListener('click', async () => {
      ...
      productFormDescription.value = data.productDescription;
      productFormQuantity.value = data.quantity;
      productFormPurchaseDate.value = data.purchaseDate;
      productFormPurchaseDate.setAttribute('disabled','false');
      productFormSupplierName.value = data.supplierName;
      productFormSupplierPhone.value = data.supplierPhone;
      productFormSupplierAddress.value = data.supplierAddress;
      // inventoryProductFormRemainingQuantity.value = data.RemainingQuantity;
      // inventoryProductFormStatus.value = data.status;
      // productFormAllotmentLoc.value = data.allotmentLoc;
      productFormWarrantyPeriod.value = data.warrantyPeriod;
      productFormCode.value = data.code;
      productFormCode.setAttribute('disabled', 'true');
      productFormRate.value = data.rate;
      productFormPOnumber.value = data.poNum;
      productFormPOnumber.setAttribute('disabled','true');
      productFormInvoiceNumber.value = data.invoiceNum;
...
if (inventoryEditButtons) {
  inventoryEditButtons.forEach((btn) => {
    btn.addEventListener('click', async () => {
      ...
      inventoryFormTitle.innerText = 'Allotment Details';
      $('[data-dismiss="modal"]').on('click', function () {
        inventoryForm.reset();
        inventoryFormTitle.innerText = 'Add New Product';
...
const servicingFormSemester = document.querySelector('.servicingForm-semester');
const servicingFormPCNum = document.querySelector('.servicingForm-pcNum');
...
if (servicingEditButtons) {
  servicingEditButtons.forEach((btn) => {
    btn.addEventListener('click', async () => {
      ...
      servicingFormSemester.value = semester;
      ...
      servicingFormPCNum.value = pcNum;
...
const expenseFormMonitors = document.querySelector('.expenseForm-monitors');
const expenseFormKeyboards = document.querySelector('.expenseForm-keyboards');
const expenseFormMouse = document.querySelector('.expenseForm-mouse');
const expenseFormMotherboard = document.querySelector('.expenseForm-motherboard');
const expenseFormProcessors = document.querySelector('.expenseForm-processors');
const expenseFormRams = document.querySelector('.expenseForm-rams');
const expenseFormHardDisks = document.querySelector('.expenseForm-harddisks');
const expenseFormLightings = document.querySelector('.expenseForm-lightings');
const expenseFormFans = document.querySelector('.expenseForm-fans');
...
if (expenseEditButtons) {
  expenseEditButtons.forEach((btn) => {
    btn.addEventListener('click', async () => {
      ...
      expenseFormMonitors.value = monitors;
      expenseFormKeyboards.value = keyboards;
      expenseFormHardDisks.value = harddisks;
      expenseFormMotherboard.value = motherboard;
      expenseFormRams.value = rams;
      expenseFormMouse.value = mouse;
      expenseFormProcessors.value = processors;
      expenseFormLightings.value = lightings;
      expenseFormFans.value = fans;
